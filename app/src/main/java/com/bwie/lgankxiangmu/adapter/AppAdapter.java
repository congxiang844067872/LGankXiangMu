...
import com.bwie.lgankxiangmu.activity.AppActivity;
...
public class AppAdapter extends RecyclerView.Adapter<MyHomeHolder> {
    private final Context context;
    private final List<AppBean.ResultsBean> list;
    private Clicklist clicked;

    public AppAdapter(Context context, List<AppBean.ResultsBean> list) {
    ...
    public void onBindViewHolder(MyHomeHolder holder, final int position) {
        AppBean.ResultsBean bean = list.get(position);
