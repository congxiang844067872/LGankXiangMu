...
import com.bwie.lgankxiangmu.activity.TuiJianActivity;
...
public class TuiJianAdapter extends RecyclerView.Adapter<MyHomeHolder> {
    private final Context context;
    private final List<TuiJianBean.ResultsBean> list;
    private Clicklist clicked;

    public TuiJianAdapter(Context context, List<TuiJianBean.ResultsBean> list) {
    ...
    public void onBindViewHolder(MyHomeHolder holder, final int position) {
        TuiJianBean.ResultsBean bean = list.get(position);
