...
public class MyIosAdapter extends RecyclerView.Adapter<MyHomeHolder> {
    private final Context context;
    private final List<IosBean.ResultsBean> list;
    private Clicklist clicked;


    public MyIosAdapter(Context activity, List<IosBean.ResultsBean> list) {
