...
import com.bwie.lgankxiangmu.activity.ShiPingActivity;
...
public class ShiPingAdapter extends RecyclerView.Adapter<MyHomeHolder> {
    private final Context context;
    private final List<ShiPingBean.ResultsBean> list;
    private Clicklist clicked;

    public ShiPingAdapter(Context context, List<ShiPingBean.ResultsBean> list) {
    ...
    public void onBindViewHolder(MyHomeHolder holder, final int position) {
        ShiPingBean.ResultsBean bean = list.get(position);
