...
public class QianDuanAdapter extends RecyclerView.Adapter<MyHomeHolder>{
    private final Context context;
    private final List<QianDuanBean.ResultsBean> list;
    private Clicklist clicked;

    public QianDuanAdapter(Context context, List<QianDuanBean.ResultsBean> list) {
    ...
    public void onBindViewHolder(MyHomeHolder holder, final int position) {
        QianDuanBean.ResultsBean bean = list.get(position);
